These notes are for the EDITORS of xsmo
...
Make sure you have an ID range in the [idranges file](xsmo-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [xsmo-edit.owl](xsmo-edit.owl)

** DO NOT EDIT xsmo.obo OR xsmo.owl in the top level directory **

[../../xsmo.owl](../../xsmo.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/pellst/xsmo) for details.
 ...
 * [xsmo-idranges.owl](xsmo-idranges.owl)
...
There are two ways to include new classes in an import module
 ...
 2. Add to the imports/xsmo_terms.txt file
...
Note: the xsmo_terms.txt file may include 'starter' classes seeded from
...
This generates derived files such as xsmo.owl and xsmo.obo and places
 ...
 * https://github.com/pellst/xsmo/releases
 * https://github.com/pellst/xsmo/releases/new
...
what is in the `owl:versionIRI` of the derived xsmo.owl (`data-version` in
xsmo.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/xsmo.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/xsmo/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/pellst/xsmo.svg?branch=master)](https://travis-ci.org/pellst/xsmo)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/pellst](https://travis-ci.org/profile/pellst)
 2. click the "Sync account" button
 3. Click the tick symbol next to xsmo
