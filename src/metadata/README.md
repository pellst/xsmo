 ...
 * [xsmo.yml](xsmo.yml)
     * Determines how your purl.obolibrary.org/obo/xsmo/ redirects will be handled
     ...
     * Paste in the contents of [xsmo.yml](xsmo.yml)
 ...
 * [xsmo.md](xsmo.md)
     ...
     * Paste in the contents of [xsmo.md](xsmo.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
